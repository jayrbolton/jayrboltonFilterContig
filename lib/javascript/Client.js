...
function jayrboltonContigFilter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (workspace_name, params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "jayrboltonContigFilter.filter_contigs",
            [workspace_name, params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "jayrboltonContigFilter.status",
